...
public class View extends JFrame implements ActionListener {
    ...
    public View(){
        try {
            String sysLookanFeelClassName = UIManager.getSystemLookAndFeelClassName();
            UIManager.setLookAndFeel(sysLookanFeelClassName);
...
//        resetUndo();
    ...
    public void showAbout(){
        JOptionPane.showMessageDialog(getContentPane(), "Author: nikola", "Version 1.0",
